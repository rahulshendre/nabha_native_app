...
export default function StudentLoginScreen() {
  ...
  function handleSubmit() {
    ...
    signIn(username, password)
      .then((u) => {
        if (u.role !== 'student') throw new Error('Please use a student account');
    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.demo}>
          ...
          <Text style={styles.demoText}>Username: student123</Text>
        ...
        <Button title={loading ? 'Logging in...' : 'Login to Dashboard'} onPress={handleSubmit} disabled={loading} accessibilityLabel="Student login" />
      </View>
    </View>
  );
}
